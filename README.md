...
The majority of the code is kept inside of the `matrix_trivia_bot` folder, which
...
To run the bot, the `matrix-trivia-bot` script in the root of the codebase is
...
the `matrix_trivia_bot` directory:
